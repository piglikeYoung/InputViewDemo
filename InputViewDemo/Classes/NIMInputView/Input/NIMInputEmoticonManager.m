...
- (NSArray *)loadChartletEmoticonCatalog{
    NSString *directory = [NIMKit_EmoticonPath stringByAppendingPathComponent:NIMKit_ChartletChartletCatalogPath];
    NSURL *url = [[NSBundle mainBundle] URLForResource: kBundleName
                                         withExtension:nil];
...
- (void)parsePlist
{
    ...
    NSString *directory = [NIMKit_EmoticonPath stringByAppendingPathComponent:NIMKit_EmojiPath];
                                 ...
                                 emoticons:(NSArray *)emoticonsArray
{
    ...
    NSString *iconNamePrefix = [[kBundleName stringByAppendingPathComponent:NIMKit_EmoticonPath] stringByAppendingPathComponent:NIMKit_EmojiPath];
    ...
    for (NSDictionary *emoticonDict in emoticonsArray) {
        ...
        NSString *imageNamePrefix = [[kBundleName stringByAppendingPathComponent:NIMKit_EmoticonPath] stringByAppendingPathComponent:NIMKit_EmojiPath];
